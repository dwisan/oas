    ...
    public function execute(Request $request)
    {
        if ($request->initSession() && $request->isReferer()) {
            ...
            if (empty($pdpa_consent)) {
                ...
                $dats = array(
                    'code' => 200,
                    'payload' => Language::replace('This website uses cookies to provide our services. To find out more about our use of cookies, please see our :privacy.', array(':privacy' => $privacy))
                );
                echo json_encode($dats, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
            }
        }
    }
